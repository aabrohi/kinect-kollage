...
namespace CCT.NUI.KinectSDK
{
    ...
    {
        public SDKRgbImageDataSource(INuiRuntime nuiRuntime)
            : base(nuiRuntime)
        { }
        ...
        void NuiRuntime_DepthFrameReady(object sender, ImageFrameReadyEventArgs e)
        {
            ...
            this.CurrentValue = System.Windows.Media.Imaging.BitmapSource.Create(image.Width, image.Height, 96, 96, PixelFormats.Bgr32, null, image.Bits, image.Width * image.BytesPerPixel);
        }
    }
}
